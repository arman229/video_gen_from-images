import {navbarname} from "../utils/Navbar"
export const footer_description:string = `is the #1 AI Video Creation Platform. Our AI Video Generator enables everyone to create professional videos without mics, cameras, actors or studios`
