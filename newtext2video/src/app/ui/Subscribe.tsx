...
import { subscribe_title, subscribe_description, subscribe_privacy } from '../utils/Subscribe'
export const Subscribe = () => {
  return (
    <div id="subscribe" className="relative bg-gray-900">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
          ...
          <form className="flex flex-col items-center w-full mb-4 md:flex-row md:px-16">
            ...
            <Button variant={"destructive"} className=" inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md md:w-auto font-medium">
              Subscribe
            </Button>
          </form>
