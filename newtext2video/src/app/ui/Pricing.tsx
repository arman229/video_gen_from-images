...
import { pricing_title, pricing_description } from "../utils/Pricing";
            ...
            <section id="pricing" className="bg-gray-100  ">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div className="flex items-center justify-center my-8  ">
                        <span
                            className={`mr-2 text-lg font-semibold ${!isYearly ? "text-gray-900" : "text-gray-400"
                                }`}
                        >
                            Monthly
                        </span>
                        <button
                            ...
                            className={` ${isYearly ? "bg-gray-400" : "bg-blue-700"
                                } relative inline-flex items-center h-6 w-11 rounded-full transition-colors duration-300 focus:outline-none   `}
                        >
                            <span
                                className={`transform transition-transform duration-300 ease-in-out inline-block w-5 h-5 rounded-full bg-white ${isYearly ? "translate-x-5" : "translate-x-1"
                                    }`}
                            />
                        </button>
                        <span
                            className={`ml-2 text-lg font-semibold ${isYearly ? "text-gray-900" : "text-gray-400"
                                }`}
                        >
